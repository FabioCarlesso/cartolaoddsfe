...
export class TimeService {
  ...
  getTime(): Observable<TimeResponse> {
    return this.http.get<any>(`${this.baseUrl}/time`).pipe(
  ...
  private mapAtleta(raw: any): Atleta {
    return {
      ...
      preco: raw.preco,
      score: raw.score,
      criterioScore: raw.criterioScore,
      scoreCriterio: raw.scoreCriterio,
      tipoScore: raw.tipoScore,
      estrategiaScore: raw.estrategiaScore,
      descricaoScore: raw.descricaoScore,
      scoreDescricao: raw.scoreDescricao,
  ...
  private mapTimeResponse(raw: any): TimeResponse {
    ...
    return {
      titulares,
      reservas,
      capitao: this.mapAtleta(raw.capitao),
      reservaLuxo: this.mapAtleta(raw.reservaLuxo),
